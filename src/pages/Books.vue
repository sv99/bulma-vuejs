          ...
          <article class="box">
            <div class="media">
              <aside class="media-left">
                <img :src="item.coverImage" width="80" />
              </aside>
              <div class="media-content">
                <p class="title is-5 is-spaced is-marginless">
                  <a @click="showEditModal = true">{{ item.title }}</a>
                </p>
    ...
    <div class="modal" :class="{ 'is-active': showNewModal }">
      ...
      <div class="modal-card">
        ...
        <footer class="modal-card-foot">
          <button class="button is-success" type="button" @click="saveBook">
            Save Book
          </button>
          <button class="button" type="cancel" @click="resetNewBookForm">
            Cancel
          </button>
        </footer>
      </div>
