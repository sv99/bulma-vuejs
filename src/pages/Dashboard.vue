      ...
      <div class="column is-12-tablet is-6-desktop is-4-fullhd">
        <div class="card">
          <div class="card-content">
            ...
            <router-link class="button is-link is-outlined" to="/orders">
              View all orders
            </router-link>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-content">
            ...
            <template v-for="(customer, key) in customers">
              <div :key="customer.id" class="media">
                <div class="media-left is-marginless">
                  <p class="number">{{ key + 1 }}</p>
                </div>
                <div class="media-content">
            ...
            <router-link class="button is-link is-outlined" to="/customers">
              View all customers
            </router-link>
          </div>
        </div>
